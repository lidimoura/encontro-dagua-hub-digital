-- ============================================
-- SPRINT FINAL: SQL SCRIPT V3 (ROLE CORRIGIDA)
-- Execute este script no Editor SQL do Supabase
-- ============================================
-- CORREÇÃO: Role 'user' → 'cliente' (constraint profiles_role_check)
-- Valid roles: 'admin', 'vendedor', 'cliente', 'cliente_restrito'
-- ============================================
...
BEGIN
  ...
  -- Criar ou atualizar profile para o usuário demo
  -- CORREÇÃO: role = 'cliente' (não 'user')
  ...
  VALUES (
    ...
    'provadagua@hub.com',
    'Prova D''água Demo',
    'cliente',  -- CORRIGIDO: role válida
    'client',   -- user_type para cliente
    demo_company_id,
    true  -- FLAG DE DEMO
  )
...
-- SCRIPT V3 CONCLUÍDO
-- ============================================
-- CORREÇÃO APLICADA: role = 'cliente' (válida)
-- Valid roles: admin, vendedor, cliente, cliente_restrito
-- ============================================
