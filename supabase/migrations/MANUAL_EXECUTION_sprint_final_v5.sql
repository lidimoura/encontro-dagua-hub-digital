-- ============================================
-- SPRINT FINAL: SQL SCRIPT V5 (SCHEMA-COMPATIBLE)
-- Execute este script no Editor SQL do Supabase
-- ============================================
-- CORREÇÃO: Usa schema REAL do banco (products table, não tech_stack separada)
-- Tech Stack = products WHERE product_type='tech_stack'
-- ============================================
...
-- ============================================
-- SCRIPT V5 CONCLUÍDO (SCHEMA-COMPATIBLE)
-- ============================================
-- CORREÇÕES APLICADAS:
-- 1. Usa products table (não tech_stack separada)
-- 2. Colunas corretas: price (não base_price), name (não nome)
-- 3. Tech stack = product_type='tech_stack'
-- 4. raw_user_meta_data com role='cliente'
-- ============================================
