...
| `/#/admin` | Admin | Painel CRUD de usuÃƒÂ¡rios (Lidi) |
...
| Papel | VisÃƒÂ£o | Rota |
|---|---|---|
| **Super Admin (Lidi)** | Todos os usuÃƒÂ¡rios do sistema | `/#/admin` |
| **Owner/Lead (Amanda)** | Apenas usuÃƒÂ¡rios da `company_id` dela | `/#/settings` |
...
- Amanda **nunca** vÃƒÂª os 10+ usuÃƒÂ¡rios de teste da Lidi
- Amanda **sÃƒÂ³** vÃƒÂª a si mesma e quem ela convidar
