...
export const translations = {
    pt: {
        ...
        'onboarding.tourStep1Desc': "Seu ecossistema digital inteligente. Vamos fazer um tour rápido!",
        'onboarding.tourStep2Title': "Contatos & Leads 👥",
        'onboarding.tourStep2Desc': "Gerencie todos os seus contatos e leads aqui. Cadastre, edite e acompanhe.",
        'onboarding.tourStep3Title': "Boards & Estratégia 📋",
        'onboarding.tourStep3Desc': "Crie boards inteligentes com IA ou use templates prontos. Kanban visual completo.",
        'onboarding.tourStep4Title': "Atividades 📝",
        'onboarding.tourStep4Desc': "Registre ligações, reuniões, tarefas e notas. Nunca perca um compromisso.",
        'onboarding.tourStep5Title': "AI Hub — Sua Equipe IA 🤖",
        'onboarding.tourStep5Desc': "Precy (preços), Jury (contratos) e Amazô (diagnóstico) trabalham 24/7 por você.",
        'onboarding.tourStep6Title': "Link d'Água 📱",
        'onboarding.tourStep6Desc': "Crie cartões digitais profissionais com QR Code e links compartilháveis.",
        ...
        'helpCenter.boardsDesc': "Crie boards com IA ou templates. Arraste cards entre colunas. Configure estratégia, metas e agentes.",
        ...
        'helpCenter.aiHubTitle': "AI Hub — Equipe IA",
        'helpCenter.aiHubDesc': "Precy calcula preços, Jury gera contratos, Amazô faz diagnóstico. Chat inteligente integrado.",
    ...
    en: {
        ...
        'onboarding.tourStep1Desc': "Your intelligent digital ecosystem. Let's take a quick tour!",
        'onboarding.tourStep2Title': "Contacts & Leads 👥",
        'onboarding.tourStep2Desc': "Manage all your contacts and leads here. Create, edit, and track.",
        'onboarding.tourStep3Title': "Boards & Strategy 📋",
        'onboarding.tourStep3Desc': "Create smart boards with AI or use ready templates. Full visual Kanban.",
        'onboarding.tourStep4Title': "Activities 📝",
        'onboarding.tourStep4Desc': "Log calls, meetings, tasks, and notes. Never miss a commitment.",
        'onboarding.tourStep5Title': "AI Hub — Your AI Team 🤖",
        'onboarding.tourStep5Desc': "Precy (pricing), Jury (contracts), and Amazô (diagnosis) work 24/7 for you.",
        'onboarding.tourStep6Title': "Link d'Água 📱",
        'onboarding.tourStep6Desc': "Create professional digital cards with QR Codes and shareable links.",
        ...
        'helpCenter.boardsTitle': "Boards & Kanban",
        'helpCenter.boardsDesc': "Create boards with AI or templates. Drag cards between columns. Configure strategy, goals, and agents.",
        ...
        'helpCenter.aiHubTitle': "AI Hub — AI Team",
        'helpCenter.aiHubDesc': "Precy calculates pricing, Jury generates contracts, Amazô diagnoses. Integrated smart chat.",
        'helpCenter.linkDaguaTitle': "Link d'Água",
