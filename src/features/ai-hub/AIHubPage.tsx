...
export const AIHubPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Critical: Auto-restore body scroll on unmount if it got locked
    return () => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-slate-50 dark:bg-dark-bg/50 overflow-y-auto overflow-x-hidden">
      {/* ── Header ── */}
